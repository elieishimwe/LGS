                ...
                <div class="fullwidthbanner" data-height="600" data-shadow="0" data-navigationStyle="preview2">
                    <ul class="hide">
                        ...
                        <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off" data-title="Slide 6">
                            ...
                            <img src="{{ asset('/images/1x1.png') }}" data-lazyload="{{ asset('/images/demo/video/back.jpg') }}" alt="video" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                            ...
                            <div class="tp-caption tp-fade fadeout fullscreenvideo"
                                ...
                                <video class="" preload="none" style="widt:100%;height:100%" poster="{{ asset('/images/demo/video/back.jpg') }}">
                                    <source src="{{ asset('/images/demo/video/back.webm') }}" type="video/webm" />
                                    <source src="{{ asset('/images/demo/video/back.mp4') }}" type="video/mp4" />
                                </video>
